...
def test_update_with_nested_dict(nested_flatdict):
    ...
    p.update({"mapping_of_literal": {"str_val": "new_string", "int_val": 0}})
...
@pytest.mark.parametrize(
    ...
    [
        (
            {"a": {"b": {"k0": 0, "k1": "1", "k2": 2.0, "k3": {"c": True}}}},
            ("a/b/k0", "a/b/k1", "a/b/k2", "a/b/k3/c"),
        ),
...
def test_flatiter_levels():
    ...
    assert list(x.flatkeys(levels=-1)) == ["a1/b2/c3", "a1/b2/d3", "b1/c2", "random"]
