...
class TestQutipBackend:
    ...
    def test_acquire_Q0X90_blobs(self, qpu_01, sim_backend, compile_Q0X90):
        ...
        for ch, trace in raw_IQ.items():
            processed_IQ_df[ch] = processor.run(trace)
