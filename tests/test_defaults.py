...
def test_replace_kwonly(defaults):
    @dynamic_default(
        __settings__=defaults, kwarg1="default_int", kwarg2="default_float"
    )
...
def test_replace_positional_only(defaults):
    with pytest.raises(ValueError):
        ...
        @dynamic_default(
            __settings__=defaults, arg1="default_int", arg2="default_float"
        )
...
def test_pass_by_position(echo_function):
    assert echo_function("arg", 2, None, "new_parent") == (
        "arg",
        2,
        None,
        "new_parent",
...
def test_pass_by_keyword(echo_function):
    ...
    assert echo_function("arg", kwarg2="new_parent", kwarg3="new_child") == (
        "arg",
        1,
        None,
        "new_parent",
...
def test_qsettings():
    @dynamic_default(
        arg1="version", kwarg2="data/directory_exist_ok", kwarg3="data/date_fmt"
    )
