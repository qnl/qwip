...
from qwip.analysis.frequency import simple_fft, get_frequency_phase
        ...
        **kwargs
        ...
        if params:
            independent_vars.update({
                name: params[name].value for name in self.independent_vars 
                    if name in params
            })
        
        independent_vars.update({
            name: kwargs[name] for name in self.independent_vars
                if name in kwargs
        })
